...
class Restaurant:
    ...
    def __init__(self, name):                       # ID, Food Name,  Quantity,  Discount,   Price,   Stock
        self.name=name
        self.food={1: {'Name': 'Tandoori Chicken', 'Quantity': 1,'piece': 4, 'Price': 240.0, 'Discount': 80.0, 'Stock': 7.0}, 
                   2: {'Name': 'Vagan Burger', 'Quantity': 1.0, 'Price': 320.0, 'Discount': 70.0, 'Stock': 6.0},
                   3: {'Name': 'Truffle Cake', 'Quantity': 500, 'Price': 900.0, 'Discount': 40.0, 'Stock': 10.0}, 
        ...
        self.user_details={1: {"User Name" : "Sherry Anjali", "Phone No." : 7780536616, "Email_ID" : 'sherry@dummy.com', 'Password' : 'FREE FOOD', 'Address' : "Hyderabad"},
                           2: {"User Name" : "Sherlyn Anjali", "Phone No." : 1234567890, "Email_ID" : 'sherlyn@dummy.com', 'Password' : 'FREE FOOD', 'Address' : "Hyderabad"}}
        self.admin_details={1: {"Admin Name" : "Anjali Goswami", "Phone No." : 7780536616, "Email_ID" : 'anjali@dummy.com', 'Password' : 'FREE FOOD', 'Address' : "Hyderabad"}}
...
try:
    def main():
        instance= Restaurant("ANJALI'S PROJECT")
